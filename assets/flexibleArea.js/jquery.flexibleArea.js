	...
	var methods = {
		init : function() {
			...
			return this.each(function(){
				...
				// Update textarea size on keyup, keydown, keypress, change, cut and paste
				$textarea.bind('keyup keydown keypress change cut paste', function(){
					updateHeight();
				});
				...
				// Update textarea on focus and blur
				$textarea.bind('focusin focus blur',function(){
					// setHeightAndOverflow();
					updateHeight();					
				});
